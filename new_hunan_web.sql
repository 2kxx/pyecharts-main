/*
 ...
 Source Host           : 47.113.185.181:3306
 Source Schema         : hunan_web

 Target Server Type    : MySQL
 Target Server Version : 50716
 File Encoding         : 65001

 Date: 18/05/2023 13:04:36
*/
...
-- ----------------------------
-- Table structure for mainapp_userinfo
-- ----------------------------
...
-- ----------------------------
-- Records of mainapp_userinfo
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for warehouse_evaluate
-- ----------------------------
...
CREATE TABLE `warehouse_evaluate` (
  ...
  `scenery_name` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`eid`)
) ENGINE=InnoDB AUTO_INCREMENT=10596 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of warehouse_evaluate
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for warehouse_scenery
-- ----------------------------
DROP TABLE IF EXISTS `warehouse_scenery`;
CREATE TABLE `warehouse_scenery` (
  `sid` int(11) NOT NULL AUTO_INCREMENT,
  `city` varchar(64) DEFAULT NULL,
  `people_percent` varchar(32) DEFAULT NULL,
  `play_time` varchar(64) DEFAULT NULL,
  `rank` double DEFAULT NULL,
  `scenery_name` varchar(64) DEFAULT NULL,
  `score` double DEFAULT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=2811 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of warehouse_scenery
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for warehouse_scenery_evaluates
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=10592 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of warehouse_scenery_evaluates
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for warehouse_spiderlog
-- ----------------------------
DROP TABLE IF EXISTS `warehouse_spiderlog`;
CREATE TABLE `warehouse_spiderlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `spider_time` datetime(6) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of warehouse_spiderlog
-- ----------------------------
BEGIN;
COMMIT;
...
INSERT INTO warehouse_data (FDRID, TimeStamp, Conv, ReceivedTime, Frequency, VoltageAng, VoltageMag, Latitude, Longitude,
                  Satellite)
...
INSERT INTO
    ...
    warehouse_data (FDRID, TimeStamp, Conv, ReceivedTime, Frequency, VoltageAng, VoltageMag, Latitude, Longitude,
                  Satellite)
